...
# Or with wget
wget -qO- https://raw.githubusercontent.com/Muneeb-Nazir/Proxmox-pve-hardware-monitor/main/pve-monitor-installer.sh | bash

# Run the installer with update flag
curl -sSL https://raw.githubusercontent.com/Muneeb-Nazir/Proxmox-pve-hardware-monitor/main/pve-monitor-installer.sh | bash -s -- --update
